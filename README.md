...
O **BookSpace** nasceu de duas grandes paixões: **literatura** e **criatividade visual**.
...
* ⭐ Avaliação de livros por notas
* ✍️ Criação de reviews pessoais
* 📊 Dashboard com métricas de leitura
* 📚 Organização da experiência literária do usuário

---

## 🎯 Objetivo

O objetivo do BookSpace é transformar a experiência de leitura em algo mais interativo, organizado e visual, permitindo que leitores acompanhem sua evolução literária e mantenham um histórico das suas opiniões sobre cada obra.

---

## 🚀 Tecnologias Utilizadas

*(Adicionar tecnologias utilizadas no projeto)*
...
Projeto desenvolvido por **Thamyres Silva**.
